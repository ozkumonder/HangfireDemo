...
namespace HangfireDemo.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public string Login()
        {
            ...
            RecurringJob.AddOrUpdate(() => Console.WriteLine("Recurring jobs tetiklendi!"), Hangfire.Cron.MinuteInterval(1));
        ...
        public String DailyOffers()
        {
            ...
            RecurringJob.AddOrUpdate(() => ClientServiceManager.Loglama(), Hangfire.Cron.MinuteInterval(1));
            return "OK!";
        }
